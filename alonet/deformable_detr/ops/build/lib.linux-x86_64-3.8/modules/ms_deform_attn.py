...
class MSDeformAttn(nn.Module):
    def __init__(self, d_model=256, n_levels=4, n_heads=8, n_points=4):
        ...
        load_MultiScaleDeformableAttention()
    ...
    def forward(self, query, reference_points, input_flatten, input_spatial_shapes, input_level_start_index, input_padding_mask=None, **kwargs):
        ...
        if "is_export_onnx" in kwargs:
            ...
            output = torch.ops.alonet_custom.ms_deform_attn_forward(value, input_spatial_shapes, input_level_start_index, sampling_locations, attention_weights, self.im2col_step)
        else:
