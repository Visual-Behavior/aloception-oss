...
COPY requirements/requirements-torch2.6.0.txt /home/aloception/install/requirements-torch2.6.0.txt
RUN pip install --no-cache-dir --target=/opt/conda/lib/python3.11/site-packages -r /home/aloception/install/requirements-torch2.6.0.txt
