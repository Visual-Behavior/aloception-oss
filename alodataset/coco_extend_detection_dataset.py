# -*- coding: utf-8 -*-
"""Based on :mod:`CocoDetectionDataset object <alodataset.coco_detection_dataset>`. Read a dataset in **COCO JSON**
...
from alodataset import BaseDataset, CocoDetectionDataset, Split, SplitMixin
...
class CocoExtendDetectionDataset(CocoDetectionDataset, SplitMixin):
    ...
    **kwargs : dict
    ...
    Examples
    --------
        >>> coco_ds = CocoExtendDetectionDataset()
